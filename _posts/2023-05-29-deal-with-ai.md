...
There is a saying: "you do not fully understand a problem until you can simplify it enough to be encoded in software program." Now that the barriers to that simplification are being lifted, the implication is that we've massively expanded the scope of problems that can be solved... and created.
